...
/**
 * PlayerChip — a member of an Aux War room: avatar, name, and the
 * WINS stat Luca asked for ("Aux War wins can be counted and shown
...
import type { AuxProfile, AuxWins } from "@/lib/db/aux-wars";
