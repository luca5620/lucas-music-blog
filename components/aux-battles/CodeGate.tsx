...
/**
 * CodeGate — the door of a PRIVATE aux battle room. Six letters from
 * the host, checked by /api/aux-battles/join (aux_join_with_code
  ...
  return (
    <div className="max-w-md mx-auto panel-xbox-glow p-6 sm:p-8 space-y-4 text-center relative overflow-hidden">
      ...
      {user ? (
        ...
        <Link href={`/login?next=/aux-battles/${slug}`} className="btn-y2k btn-y2k-primary inline-block">
          {t("signIn")}
        </Link>
      )}
