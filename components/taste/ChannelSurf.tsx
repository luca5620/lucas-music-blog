      ...
      >
        ...
        {fullscreen && hasVideo && playing && item.type === "post" ? (
          ...
          >
            ...
            {/* No corner rating badge on the cover — the "{name} rated
                it {score}" line above the poster already carries the
                score (Luca 2026-08-28: cover stays clean). */}
        ...
        <span className="block max-w-md space-y-1">
          ...
          {/* Reason chips deliberately NOT rendered (Luca 2026-08-28:
              labels like "critic segment" / "rec 8d ago" don't fit —
              the engine still uses reasons for ranking, silently). */}
        </span>
