...
| showcase | a block a member arranges on their profile | vitrina | vitrine | vitrine | showcase | Showcase |
...
| low detail mode | the performance toggle | modo de detalle bajo | mode détails réduits | modo de baixo detalhe | lage-detailmodus | Modus mit wenig Details |
