 ...
 * of a Aux War room, you should have the choice to remove people
...
import type { AuxBanWithProfile, AuxMemberWithProfile } from "@/lib/db/aux-wars";
...
export default function ManagePeople({
  ...
  async function act(userId: string, ban: boolean, profile: AuxMemberWithProfile["profile"]) {
    ...
    setError(null);
    try {
      const res = await fetch(`/api/aux-wars/${roomId}/bans`, {
        method: "POST",
