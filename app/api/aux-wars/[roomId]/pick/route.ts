...
import { cleanSong, isAuxSong } from "@/lib/aux-wars/songs";
import { ensureRelease } from "@/lib/catalog";

/**
 * POST /api/aux-wars/[roomId]/pick  { song: AuxSong }
 *
 * A player puts their song on for the CURRENT game. The card was
 * built by /api/aux-wars/songs (search or link) and comes back from the
