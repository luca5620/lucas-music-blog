...
export const metadata: Metadata = {
  title: "About",
  description:
    "Peak Music Reviews is a free music social network and review app: rate albums and songs 0–10, write reviews, build lists, join live release-night rooms and Aux Wars. Web + iOS. Unreleased music included.",
  alternates: {
