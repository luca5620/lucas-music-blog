...
export const metadata: Metadata = {
  ...
  description:
    "Rate albums, log your taste, join live release rooms and Aux Wars. A music social platform — every record on Spotify and the deep Genius catalog, unreleased included.",
  alternates: {
  ...
  openGraph: {
    ...
    description:
      "Rate albums, build lists, join live release rooms and Aux Wars. Letterboxd energy for music.",
    images: [
      {
  ...
  twitter: {
    ...
    title: "Peak Music Reviews — the music social network",
    description:
      "Rate albums, build lists, join live release rooms and Aux Wars.",
  },
  robots: {
    index: true,
    follow: true,
