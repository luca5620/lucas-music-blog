 ...
 *
 * Recovered from the old debates section (deleted 2026-09-13 when Aux
 * Wars replaced it) for debate POSTS, migration 048. Unchanged except
 * for the copy namespace, which moved from `debates.voteBar` to
 * `posts.debate.voteBar`.
 *
...
export default function VoteBar({
  ...
  const t = useTranslations("posts.debate.voteBar");
  const total = a + b;
